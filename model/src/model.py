...
from data_modification import format_time
...
def print_statistics(algorithmName, y_pred, y_test):
...
def train_and_test_models():
    ...
    print_statistics(algorithmName="Random Forest Regressor", 
        y_pred=rf.fit(X_train_normalized, y_train).predict(X_test_normalized), y_test=y_test)

    et = ExtraTreesRegressor(n_estimators=30, max_depth=180, min_samples_split=10)
    print_statistics(algorithmName="Extra Trees Regressor",
    ...
    print_statistics(algorithmName="Gradient Boosting Regressor",
    ...
    print_statistics(algorithmName="Hist Gradient Boosting Regressor",
    ...
    print_statistics(algorithmName="Multi-layer Perceptron Regressor",
